...
import icu.takeneko.omms.client.session.callback.AnnouncementListCallbackHandle;
import icu.takeneko.omms.client.session.callback.BiStringCallbackHandle;
import icu.takeneko.omms.client.session.callback.BooleanCallbackHandle;
import icu.takeneko.omms.client.session.callback.Callback;
import icu.takeneko.omms.client.session.callback.Callback2;
import icu.takeneko.omms.client.session.callback.ControllerCommandLogCallbackHandle;
import icu.takeneko.omms.client.session.callback.ControllerListCallbackHandle;
import icu.takeneko.omms.client.session.callback.EnumCallbackHandle;
import icu.takeneko.omms.client.session.callback.JsonObjectCallbackHandle;
import icu.takeneko.omms.client.session.callback.StatusCallbackHandle;
import icu.takeneko.omms.client.session.callback.StringCallbackHandle;
import icu.takeneko.omms.client.session.callback.SystemInfoCallbackHandle;
import icu.takeneko.omms.client.session.callback.WhitelistListCallbackHandle;
